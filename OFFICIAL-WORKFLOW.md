...
This project stores only its custom source and emits an overlay with the same three relevant definition shapes:
...
each product. It generates JetBrains and Hyper definitions together and keeps IDs consistent.
